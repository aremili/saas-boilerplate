...
async def create_task(
    ...
    task_html = templates.get_template("task/partials/task_item.html").render(
...
async def delete_task(request: Request, task_id: int, repo: TaskRepoDep):
    ...
    if task:
        ...
        empty_state_html = ""
        if total == 0:
            empty_state_html = templates.get_template("task/partials/task_list.html").render(
